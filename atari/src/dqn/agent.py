...
class Agent:
    def __init__(self, environment, hyperparams):
        ...
        self.online_model = DuelCNN(h=self.target_h, w=self.target_w, output_size=self.action_size).to(hyperparams.environment.device)
        self.target_model = DuelCNN(h=self.target_h, w=self.target_w, output_size=self.action_size).to(hyperparams.environment.device)
