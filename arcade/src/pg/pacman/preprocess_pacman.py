...
def preprocess_pacman_frame_difference(current_frame: np.ndarray, previous_frame: np.ndarray = None) -> np.ndarray:
    """
...
def preprocess_pacman_frame_color_aware_difference(current_frame: np.ndarray, previous_frame: np.ndarray = None) -> np.ndarray:
    """
