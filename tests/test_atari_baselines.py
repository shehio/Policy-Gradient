...
try:
    from atari_baseline_train import parse_arguments, get_env_name, ensure_model_dir, find_latest_model
    from atari_baseline_test import parse_arguments as test_parse_arguments, detect_algorithm_from_model
...
class TestAtariBaselineTest:
    ...
    def test_detect_algorithm_from_model(self):
        ...
        with patch('atari_baseline_test.PPO', mock_ppo), \
             patch('atari_baseline_test.DQN', mock_dqn), \
