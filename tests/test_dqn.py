...
sys.path.insert(
    0,
    os.path.join(os.path.dirname(__file__), "..", "atari", "algorithms", "dqn", "src"),
)
...
class TestDuelingCNN:
    ...
    def test_model_forward_pass(self):
        ...
        with patch("model.torch") as mock_torch:
            ...
            mock_output.cpu.return_value.numpy.return_value = np.random.randn(
                batch_size, 6
            )
...
class TestDQNIntegration:
    ...
    def test_dqn_script_imports(self):
        ...
        scripts_path = os.path.join(
            os.path.dirname(__file__), "..", "atari", "algorithms", "dqn", "scripts"
        )
